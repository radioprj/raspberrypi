...
Obraz można też zapisać przy pomocy [Raspbian IMAGER - patrz opis](https://raw.githubusercontent.com/radioprj/opisy/main/Raspberry_IMAGER_hotspotfm.pdf)  ale w wersji 1.9.x (nie używać najnowszej wersji 2.x nie pozwala ustawiać WiFi dla obrazów własnych)
